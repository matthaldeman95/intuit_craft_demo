...
Windows (Powershell 3 or later***REMOVED***
===============================

For best results, uninstall previous versions FIRST (see `Uninstalling`_***REMOVED***.

Using Windows 8 (which includes PowerShell 3***REMOVED*** or earlier versions of Windows
...
Powershell command. Start up Powershell and paste this command::
    ...
    > (Invoke-WebRequest https://bootstrap.pypa.io/ez_setup.py***REMOVED***.Content | python -
...
to install a user-local installation::
    ...
    > (Invoke-WebRequest https://bootstrap.pypa.io/ez_setup.py***REMOVED***.Content | python - --user
...
Python 2.7 installed::
    ...
    > (Invoke-WebRequest https://bootstrap.pypa.io/ez_setup.py***REMOVED***.Content | py -3 -
...
Note that on some older systems (noted on Debian 6 and CentOS 5 installations***REMOVED***,
...
(see `Issue 59 <https://bitbucket.org/pypa/pypi/issue/59#comment-5881915>`_***REMOVED***. If you happen to encounter them,
...
Unix including Mac OS X (curl***REMOVED***
==============================
...
(and any other ``sys.path`` directories***REMOVED*** FIRST.
...
mailing list`_. If you have written (or know of***REMOVED*** any tutorials, documentation,
...
* Significant parts of the implementation of setuptools were funded by the Open
  ...
  "Code Bear" Taylor***REMOVED*** contributed their time and stress as guinea pigs for the
  use of eggs and setuptools, even before eggs were "cool".  (Thanks, guys!***REMOVED***
...
* Since the merge with Distribute, Jason R. Coombs is the
  ...
  the Python Packaging Authority (PyPA***REMOVED*** and the larger Python community.

...
==============================================================================
beta                 Beta distribution over ``[0, 1***REMOVED***``.
binomial             Binomial distribution.
chisquare            :math:`\\chi^2` distribution.
exponential          Exponential distribution.
f                    F (Fisher-Snedecor***REMOVED*** distribution.
...
wald                 Wald (inverse Gaussian***REMOVED*** distribution.
...
__all__.extend(['ranf', 'random', 'sample'***REMOVED******REMOVED***

def __RandomState_ctor(***REMOVED***:
    ***REMOVED***Return a RandomState instance.

    This function exists solely to assist (un***REMOVED***pickling.
    ...
    ***REMOVED***
    return RandomState(seed=0***REMOVED***

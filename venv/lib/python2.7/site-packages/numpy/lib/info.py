...
mod              Modulo mod(x,y***REMOVED*** = x % y except keeps sign of y
...
unwrap           Unwrap phase along given axis (1-d algorithm***REMOVED***
sort_complex     Sort a complex-array (based on real, then imaginary***REMOVED***
...
vstack           Stack arrays vertically (row on row***REMOVED***
hstack           Stack arrays horizontally (column on column***REMOVED***
column_stack     Stack 1D arrays as columns into 2D array
dstack           Stack arrays depthwise (along third dimension***REMOVED***
...
Matrix (2D Array***REMOVED*** Manipulations
-------------------------------
================ ===================
...
-----------------------
Set operations for 1D numeric arrays based on sort(***REMOVED*** function.

================ ===================
ediff1d          Array difference (auxiliary function***REMOVED***.
...
depends = ['core', 'testing'***REMOVED***
global_symbols = ['*'***REMOVED***

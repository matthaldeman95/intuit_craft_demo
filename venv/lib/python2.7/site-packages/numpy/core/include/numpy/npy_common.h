...
#define NPY_GCC_UNROLL_LOOPS \
    __attribute__((optimize("unroll-loops"***REMOVED******REMOVED******REMOVED***
#else
#define NPY_GCC_UNROLL_LOOPS
#endif
...
#define NPY_GCC_OPT_3 __attribute__((optimize("O3"***REMOVED******REMOVED******REMOVED***
#else
#define NPY_GCC_OPT_3
#endif

/*
 * mark an argument (starting from 1***REMOVED*** that must not be NULL and is not checked
 * DO NOT USE IF FUNCTION CHECKS FOR NULL!! the compiler will remove the check
 */
#ifdef HAVE_ATTRIBUTE_NONNULL
#define NPY_GCC_NONNULL(n***REMOVED*** __attribute__((nonnull(n***REMOVED******REMOVED******REMOVED***
#else
#define NPY_GCC_NONNULL(n***REMOVED***
#endif
 ...
 *
 * if (NPY_UNLIKELY(failure == 0***REMOVED******REMOVED***
 *    return NULL;
 *
 * the double !! is to cast the expression (e.g. NULL***REMOVED*** to a boolean required by
 * the intrinsic
 */
#ifdef HAVE___BUILTIN_EXPECT
#define NPY_LIKELY(x***REMOVED*** __builtin_expect(!!(x***REMOVED***, 1***REMOVED***
#define NPY_UNLIKELY(x***REMOVED*** __builtin_expect(!!(x***REMOVED***, 0***REMOVED***
#else
#define NPY_LIKELY(x***REMOVED*** (x***REMOVED***
#define NPY_UNLIKELY(x***REMOVED*** (x***REMOVED***
#endif

#ifdef HAVE___BUILTIN_PREFETCH
/* unlike _mm_prefetch also works on non-x86 */
#define NPY_PREFETCH(x, rw, loc***REMOVED*** __builtin_prefetch((x***REMOVED***, (rw***REMOVED***, (loc***REMOVED******REMOVED***
#else
#ifdef HAVE__MM_PREFETCH
/* _MM_HINT_ET[01***REMOVED*** (rw = 1***REMOVED*** unsupported, only available in gcc >= 4.9 */
#define NPY_PREFETCH(x, rw, loc***REMOVED*** _mm_prefetch((x***REMOVED***, loc == 0 ? _MM_HINT_NTA : \
                                             (loc == 1 ? _MM_HINT_T2 : \
                                              (loc == 2 ? _MM_HINT_T1 : \
                                               (loc == 3 ? _MM_HINT_T0 : -1***REMOVED******REMOVED******REMOVED******REMOVED***
#else
#define NPY_PREFETCH(x, rw,loc***REMOVED***
#endif
#endif

#if defined(_MSC_VER***REMOVED***
        #define NPY_INLINE __inline
#elif defined(__GNUC__***REMOVED***
	#if defined(__STRICT_ANSI__***REMOVED***
    ...
    #define NPY_TLS __thread
        ...
        #define NPY_TLS __declspec(thread***REMOVED***
    #else
        #define NPY_TLS
    #endif
#endif
  ...
  #define NPY_RETURNS_BORROWED_REF \
    __attribute__((cpychecker_returns_borrowed_ref***REMOVED******REMOVED***
#else
  #define NPY_RETURNS_BORROWED_REF
#endif

#ifdef WITH_CPYCHECKER_STEALS_REFERENCE_TO_ARG_ATTRIBUTE
  #define NPY_STEALS_REF_TO_ARG(n***REMOVED*** \
   __attribute__((cpychecker_steals_reference_to_arg(n***REMOVED******REMOVED******REMOVED***
#else
 #define NPY_STEALS_REF_TO_ARG(n***REMOVED***
#endif

/* 64 bit file position support, also on win-amd64. Ticket #1660 */
#if defined(_MSC_VER***REMOVED*** && defined(_WIN64***REMOVED*** && (_MSC_VER > 1400***REMOVED*** || \
    defined(__MINGW32__***REMOVED*** || defined(__MINGW64__***REMOVED***
    #include <io.h>

/* mingw based on 3.4.5 has lseek but not ftell/fseek */
#if defined(__MINGW32__***REMOVED*** || defined(__MINGW64__***REMOVED***
extern int __cdecl _fseeki64(FILE *, long long, int***REMOVED***;
extern long long __cdecl _ftelli64(FILE ****REMOVED***;
#endif
 ...
 */
...
#elif defined(PY_LONG_LONG***REMOVED*** && (NPY_SIZEOF_PY_INTPTR_T == NPY_SIZEOF_LONGLONG***REMOVED***
    ...
    #if (PY_VERSION_HEX >= 0x02070000***REMOVED***
 ...
 */
#if (NPY_USE_C99_FORMATS***REMOVED*** == 1 \
        && (defined HAVE_UINTPTR_T***REMOVED*** \
        && (defined HAVE_INTTYPES_H***REMOVED***
        #include <inttypes.h>
        #undef NPY_INTP_FMT
...
#  endif
#  ifdef _MSC_VER
#    define NPY_LONGLONG_SUFFIX(x***REMOVED***   (x##i64***REMOVED***
#    define NPY_ULONGLONG_SUFFIX(x***REMOVED***  (x##Ui64***REMOVED***
#  else
#    define NPY_LONGLONG_SUFFIX(x***REMOVED***   (x##LL***REMOVED***
#    define NPY_ULONGLONG_SUFFIX(x***REMOVED***  (x##ULL***REMOVED***
#  endif
#else
typedef long npy_longlong;
typedef unsigned long npy_ulonglong;
#  define NPY_LONGLONG_SUFFIX(x***REMOVED***  (x##L***REMOVED***
#  define NPY_ULONGLONG_SUFFIX(x***REMOVED*** (x##UL***REMOVED***
#endif
 ...
 */
#if 0
#if defined(NPY_USE_C99_COMPLEX***REMOVED*** && defined(NPY_HAVE_COMPLEX_DOUBLE***REMOVED***
typedef complex npy_cdouble;
#else
typedef struct { double real, imag; ***REMOVED*** npy_cdouble;
#endif

#if defined(NPY_USE_C99_COMPLEX***REMOVED*** && defined(NPY_HAVE_COMPLEX_FLOAT***REMOVED***
typedef complex float npy_cfloat;
#else
typedef struct { float real, imag; ***REMOVED*** npy_cfloat;
#endif

#if defined(NPY_USE_C99_COMPLEX***REMOVED*** && defined(NPY_HAVE_COMPLEX_LONG_DOUBLE***REMOVED***
...
#define NPY_MIN_INT32 (-NPY_MAX_INT32 - 1***REMOVED***
#define NPY_MAX_UINT32 4294967295U
#define NPY_MAX_INT64 NPY_LONGLONG_SUFFIX(9223372036854775807***REMOVED***
#define NPY_MIN_INT64 (-NPY_MAX_INT64 - NPY_LONGLONG_SUFFIX(1***REMOVED******REMOVED***
#define NPY_MAX_UINT64 NPY_ULONGLONG_SUFFIX(18446744073709551615***REMOVED***
#define NPY_MAX_INT128 NPY_LONGLONG_SUFFIX(85070591730234615865843651857942052864***REMOVED***
#define NPY_MIN_INT128 (-NPY_MAX_INT128 - NPY_LONGLONG_SUFFIX(1***REMOVED******REMOVED***
#define NPY_MAX_UINT128 NPY_ULONGLONG_SUFFIX(170141183460469231731687303715884105728***REMOVED***
#define NPY_MAX_INT256 NPY_LONGLONG_SUFFIX(57896044618658097711785492504343953926634992332820282019728792003956564819967***REMOVED***
#define NPY_MIN_INT256 (-NPY_MAX_INT256 - NPY_LONGLONG_SUFFIX(1***REMOVED******REMOVED***
#define NPY_MAX_UINT256 NPY_ULONGLONG_SUFFIX(115792089237316195423570985008687907853269984665640564039457584007913129639935***REMOVED***
...
#define NPY_MAX_TIMEDELTA NPY_MAX_INT64
        ...
        /* Need to find the number of bits for each type and
           ...
           C states that sizeof(char***REMOVED*** == 1 by definition

           So, just using the sizeof keyword won't help.

           It also looks like Python itself uses sizeof(char***REMOVED*** quite a
...
#ifndef INT_MIN
#define INT_MIN (-INT_MAX - 1***REMOVED***
#endif
...
#define NPY_BITSOF_BOOL (sizeof(npy_bool***REMOVED*** * CHAR_BIT***REMOVED***
#define NPY_BITSOF_CHAR CHAR_BIT
#define NPY_BITSOF_BYTE (NPY_SIZEOF_BYTE * CHAR_BIT***REMOVED***
#define NPY_BITSOF_SHORT (NPY_SIZEOF_SHORT * CHAR_BIT***REMOVED***
#define NPY_BITSOF_INT (NPY_SIZEOF_INT * CHAR_BIT***REMOVED***
#define NPY_BITSOF_LONG (NPY_SIZEOF_LONG * CHAR_BIT***REMOVED***
#define NPY_BITSOF_LONGLONG (NPY_SIZEOF_LONGLONG * CHAR_BIT***REMOVED***
#define NPY_BITSOF_INTP (NPY_SIZEOF_INTP * CHAR_BIT***REMOVED***
#define NPY_BITSOF_HALF (NPY_SIZEOF_HALF * CHAR_BIT***REMOVED***
#define NPY_BITSOF_FLOAT (NPY_SIZEOF_FLOAT * CHAR_BIT***REMOVED***
#define NPY_BITSOF_DOUBLE (NPY_SIZEOF_DOUBLE * CHAR_BIT***REMOVED***
#define NPY_BITSOF_LONGDOUBLE (NPY_SIZEOF_LONGDOUBLE * CHAR_BIT***REMOVED***
#define NPY_BITSOF_CFLOAT (NPY_SIZEOF_CFLOAT * CHAR_BIT***REMOVED***
#define NPY_BITSOF_CDOUBLE (NPY_SIZEOF_CDOUBLE * CHAR_BIT***REMOVED***
#define NPY_BITSOF_CLONGDOUBLE (NPY_SIZEOF_CLONGDOUBLE * CHAR_BIT***REMOVED***
#define NPY_BITSOF_DATETIME (NPY_SIZEOF_DATETIME * CHAR_BIT***REMOVED***
#define NPY_BITSOF_TIMEDELTA (NPY_SIZEOF_TIMEDELTA * CHAR_BIT***REMOVED***

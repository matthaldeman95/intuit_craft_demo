...
#if defined(_WIN32***REMOVED***
#define _WARN___STR2__(x***REMOVED*** #x
#define _WARN___STR1__(x***REMOVED*** _WARN___STR2__(x***REMOVED***
#define _WARN___LOC__ __FILE__ "(" _WARN___STR1__(__LINE__***REMOVED*** "***REMOVED*** : Warning Msg: "
#pragma message(_WARN___LOC__"Using deprecated NumPy API, disable it by " \
                         "#defining NPY_NO_DEPRECATED_API NPY_1_7_API_VERSION"***REMOVED***
...
#define PyDataType_GetDatetimeMetaData(descr***REMOVED***                                 \
    ((descr->metadata == NULL***REMOVED*** ? NULL :                                       \
        ((PyArray_DatetimeMetaData ****REMOVED***(PyCapsule_GetPointer(                   \
                PyDict_GetItemString(                                         \
                    descr->metadata, NPY_METADATA_DTSTR***REMOVED***, NULL***REMOVED******REMOVED******REMOVED******REMOVED***
#else
#define PyDataType_GetDatetimeMetaData(descr***REMOVED***                                 \
    ((descr->metadata == NULL***REMOVED*** ? NULL :                                       \
        ((PyArray_DatetimeMetaData ****REMOVED***(PyCObject_AsVoidPtr(                    \
                PyDict_GetItemString(descr->metadata, NPY_METADATA_DTSTR***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***
#endif

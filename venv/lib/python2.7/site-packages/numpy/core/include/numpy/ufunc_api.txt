...
::
  ...
  PyUFunc_RegisterLoopForType(PyUFuncObject *ufunc, int
                              ...
                              function, int *arg_types, void *data***REMOVED***
...
::
  ...
  PyUFunc_GenericFunction(PyUFuncObject *ufunc, PyObject *args, PyObject
                          *kwds, PyArrayObject **op***REMOVED***


This generic function is called with the ufunc object, the arguments to it,
and an array of (pointers to***REMOVED*** PyArrayObjects which are NULL.
...
::
  ...
  int
  PyUFunc_checkfperr(int errmask, PyObject *errobj, int *first***REMOVED***


::

  void
  PyUFunc_clearfperr(***REMOVED***


::

  int
  PyUFunc_getfperr(void ***REMOVED***
...
::
  ...
  int
  PyUFunc_SetUsesArraysAsData(void **data, size_t i***REMOVED***
...
::
  ...
  PyUFunc_DefaultTypeResolver(PyUFuncObject *ufunc, NPY_CASTING
                              ...
                              **operands, PyObject
                              *type_tup, PyArray_Descr **out_dtypes***REMOVED***
...
::
  ...
  PyUFunc_ValidateCasting(PyUFuncObject *ufunc, NPY_CASTING
                          casting, PyArrayObject
                          **operands, PyArray_Descr **dtypes***REMOVED***
...
Returns 0 on success, -1 (with exception raised***REMOVED*** on validation failure.

...
#define MIN_INT32 (-MAX_INT32 - 1***REMOVED***
#define MAX_UINT32 4294967295U
#define MAX_INT64 LONGLONG_SUFFIX(9223372036854775807***REMOVED***
#define MIN_INT64 (-MAX_INT64 - LONGLONG_SUFFIX(1***REMOVED******REMOVED***
#define MAX_UINT64 ULONGLONG_SUFFIX(18446744073709551615***REMOVED***
#define MAX_INT128 LONGLONG_SUFFIX(85070591730234615865843651857942052864***REMOVED***
#define MIN_INT128 (-MAX_INT128 - LONGLONG_SUFFIX(1***REMOVED******REMOVED***
#define MAX_UINT128 ULONGLONG_SUFFIX(170141183460469231731687303715884105728***REMOVED***
#define MAX_INT256 LONGLONG_SUFFIX(57896044618658097711785492504343953926634992332820282019728792003956564819967***REMOVED***
#define MIN_INT256 (-MAX_INT256 - LONGLONG_SUFFIX(1***REMOVED******REMOVED***
#define MAX_UINT256 ULONGLONG_SUFFIX(115792089237316195423570985008687907853269984665640564039457584007913129639935***REMOVED***

...
cats = ['Cc', 'Cf', 'Cn', 'Co', 'Cs', 'Ll', 'Lm', 'Lo', 'Lt', 'Lu', 'Mc', 'Me', 'Mn', 'Nd', 'Nl', 'No', 'Pc', 'Pd', 'Pe', 'Pf', 'Pi', 'Po', 'Ps', 'Sc', 'Sk', 'Sm', 'So', 'Zl', 'Zp', 'Zs'***REMOVED***

def combine(*args***REMOVED***:
    return u''.join([globals(***REMOVED***[cat***REMOVED*** for cat in args***REMOVED******REMOVED***
...
def allexcept(*args***REMOVED***:
    newcats = cats[:***REMOVED***
    for arg in args:
        newcats.remove(arg***REMOVED***
    return u''.join([globals(***REMOVED***[cat***REMOVED*** for cat in newcats***REMOVED******REMOVED***
...
if __name__ == '__main__':
    ...
    f = open(__file__.rstrip('co'***REMOVED******REMOVED***
    ***REMOVED***
        content = f.read(***REMOVED***
    finally:
        f.close(***REMOVED***

    header = content[:content.find('Cc ='***REMOVED******REMOVED***
    footer = content[content.find("def combine("***REMOVED***:***REMOVED***

    for code in range(65535***REMOVED***:
        c = unichr(code***REMOVED***
        cat = unicodedata.category(c***REMOVED***
        categories.setdefault(cat, [***REMOVED******REMOVED***.append(c***REMOVED***

    f = open(__file__, 'w'***REMOVED***
    f.write(header***REMOVED***

    for cat in sorted(categories***REMOVED***:
        val = u''.join(categories[cat***REMOVED******REMOVED***
        if cat == 'Cs':
...
***REMOVED***
    ...
    Cs = '' # Jython can't handle isolated surrogates\n\n***REMOVED*** % val***REMOVED***
            ...
            f.write('%s = %r\n\n' % (cat, val***REMOVED******REMOVED***
    f.write('cats = %r\n\n' % sorted(categories.keys(***REMOVED******REMOVED******REMOVED***

    f.write(footer***REMOVED***
    f.close(***REMOVED***
